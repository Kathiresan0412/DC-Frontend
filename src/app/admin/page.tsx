    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="flex items-center justify-between border-b border-border px-4 py-4 md:px-8">
        <div className="flex items-center gap-3">
          <div className="relative h-12 w-12 shrink-0 overflow-hidden rounded-xl border border-border bg-white shadow-sm">
            <Image src="/primozen-icon.png" alt="Primozen logo" fill className="object-contain" priority sizes="48px" />
          </div>
          <div>
            <p className="font-bold leading-tight">Primozen Admin</p>
            <p className="text-xs text-muted-foreground">Frozen Solution + Primecut Services</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Link href="/" className="inline-flex h-8 items-center justify-center gap-1.5 rounded-lg border border-border bg-background px-2.5 text-sm font-medium transition-all hover:bg-muted">
